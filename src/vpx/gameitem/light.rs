...
use super::{color::ColorARGB, point::Point, vertex2d::Vertex2D};
...
impl BiffRead for Light {
    fn biff_read(reader: &mut BiffReader<'_>) -> Light {
        ...
        let mut color: ColorARGB = ColorARGB::new(0xffff00);
        let mut color2: ColorARGB = ColorARGB::new(0xffffff);
        ...
        loop {
            ...
            match tag_str {
                ...
                "RADI" => {
                    falloff_radius = reader.get_float();
                }
                "FAPO" => {
                    falloff_power = reader.get_float();
                }
                "STAT" => {
                    status = reader.get_u32();
                }
                "COLR" => {
                    color = ColorARGB::biff_read(reader);
                }
                "COL2" => {
                    color2 = ColorARGB::biff_read(reader);
                }
                "TMON" => {
                ...
                "BWTH" => {
                    intensity = reader.get_float();
                }
                "TRMS" => {
                    transmission_scale = reader.get_float();
                }
                "SURF" => {
                ...
                "LIDB" => {
                    depth_bias = reader.get_float();
                }
                "FASP" => {
                    fade_speed_up = reader.get_float();
                }
                "FASD" => {
                    fade_speed_down = reader.get_float();
                }
                "BULT" => {
                ...
                "BMSC" => {
                    mesh_radius = reader.get_float();
                }
                "BMVA" => {
                    bulb_modulate_vs_add = reader.get_float();
                }
                "BHHI" => {
                    bulb_halo_height = reader.get_float();
                }
                // many of these
                "DPNT" => {
